...
data class BusinessLogicCriteria(
    val useCaseImplementationWeight: Double = 0.35, // 35% - Use case functionality
    val repositoryImplementationWeight: Double = 0.30, // 30% - Data access layer
    val viewModelConnectivityWeight: Double = 0.25, // 25% - UI-business logic bridge
    val domainModelValidationWeight: Double = 0.10  // 10% - Domain model integrity
)
